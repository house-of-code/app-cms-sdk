    ...
    Object.defineProperty(AppCMSClient.prototype, "cphtrucking", {
        get: function () {
            ...
            return {
                ...
                tasksUpdateStatus: function (taskId, statusId, note, delay) {
                    return _this.makeRequest(_this.generateURL("/cphtrucking/tasks/" + taskId + "/status"), "put", { vin_status_id: statusId, note: note, delay: delay });
                },
                statuses: function () {
                ...
                taskCreate: function (taskDate, customerId, taskName, destinationStreetAddress, destinationCity, destinationPostalCode, statusId, orderTypeId, estimate, description, note, taskId) {
                    return _this.makeRequest(_this.generateURL("/cphtrucking/engineer-login"), "post", { ct_task: {
